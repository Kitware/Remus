...
//make a internal namespace for the private work and service classes
namespace meshserver {
namespace mdp {
namespace internal
{
...
class worker {
   friend class meshserver::mdp::broker;
public:
   //  ---------------------------------------------------------------------
...
using meshserver::mdp::internal::service;
using meshserver::mdp::internal::worker;
class broker {
public:
